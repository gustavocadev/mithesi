  ...
  'inline-flex items-center justify-center rounded text-sm font-medium transition-all duration-100 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      look: {
        ...
        ghost: 'text-accent-foreground hover:bg-gray-200',
        link: 'text-foreground hover:bg-transparent hover:text-foreground/80 hover:underline hover:underline-offset-2',
        destructive:
          'border-red-500 bg-red-500 text-white shadow-sm hover:bg-red-600 active:shadow-base active:press',
        success:
          'border-green-500 bg-green-500 text-white shadow-sm hover:bg-green-600 active:shadow-base active:press',
        edit: 'border-yellow-500 bg-yellow-500 text-white shadow-sm hover:bg-yellow-600 active:shadow-base active:press',
      },
      size: {
